    ...
    public class GUI
    {
        ...
        public void DrawTradeWindow(int x, int y, Action action, Player player, Trader trader, bool isVisible)
        {
            if (isVisible)
            {
                ...
                DrawBox(x, y + Height / 2, Width / 2, 3, null, false, false);
                trader.PrintItems(Width / 2 + 2, 0, Width / 2);
                ...
                if (itemSelected)
                {
                    DrawBox(0, y, 32, 7, null, false, false);
                    player.PrintItemOptions(2, y, action);
                }
            }      
        }
